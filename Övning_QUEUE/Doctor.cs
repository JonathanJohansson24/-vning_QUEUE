...
namespace Övning_QUEUE
{
    internal class Doctor : Person
    {
        ...
        public Doctor(int salary, int workHours, int socNumber, string name, int age, string role, bool workingAtHospital) : base (socNumber, name, age, role, workingAtHospital) 
        {
